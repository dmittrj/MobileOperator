...
VALUES
	...
	('Эконом', 'Тариф для экономных пользователей, включающий в себя 100 минут, 50 SMS и 500 Мб трафика в месяц.', 'Недоступен для подключения жителяем Москвы и области', '01/01/2022', 100, 50, 0.5, NULL, 300, 0),
